...
export function createRescueBudget(maxCalls?:number):Budget{const cap=Math.max(0,Math.min(64,Number(maxCalls??process.env.CANONICAL_RESCUE_MAX_CALLS||16)));return{remaining:cap,attempted:0,cacheHits:0,resolved:0,failed:0,providers:{},reasons:{}};}
